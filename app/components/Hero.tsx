  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute right-[8%] top-[30%] h-72 w-72 rounded-full bg-fuchsia-500/10 blur-[100px]" />
        <div
              ...
              {socials.map((s) => {
                ...
                return (
                  <a
                    ...
                    aria-label={s.label}
                    className="grid h-9 w-9 place-items-center rounded-full border border-border bg-card text-foreground transition-colors hover:border-accent hover:text-accent"
                  >
      ...
      {/* Stats */}
      <div className="mx-5 mt-16 grid grid-cols-2 gap-px overflow-hidden rounded-2xl border border-border bg-border sm:mx-8 sm:mt-20 sm:grid-cols-4 lg:mx-auto lg:max-w-6xl">
        {stats.map((stat) => (
          <div
            key={stat.label}
            className="bg-card px-5 py-6 text-center sm:py-8"
          >
